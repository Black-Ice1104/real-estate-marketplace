// Create a context to store the authentication info in local storage
// e.g. Username, token, refresh token, etc
...
const AuthProvider = ({children}) => {
    ...
    // config axios, so that no need to include ${API} in Register.js:
